...
<html>
    <head>
        <title>Application | Mansto</title>
        <meta charset="UTF-8">
    ...
    <body>
        ...
        <script src="../../../static/assets/js/initializer.js"></script>
