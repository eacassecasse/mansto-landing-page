...
var Layout = function () {
    ...
    /** ADDED BY EDMILSON CASSECASSE **/
    //Testing localStorage availability and support
    function storageAvailable(type) {
        ...
        try {
            ...
            return e instanceof DOMException && (
                    ...
                    //Firefox
                    e.code === 1014 ||
                    //test name field too, bacause code might not be present
                    //everything except Firefox
            ...
            function visitCount() {
                if (storageAvailable('localStorage')) {
                    var counter = localStorage.getItem('visits_count') ?
                            Number(localStorage.getItem('visits_count')) : 0;

                    if (counter === 0) {
                        localStorage.setItem('visits_count', 1);
                        localStorage.setItem('last_visit', new Date());
                    } else {
                        counter++;
                        localStorage.setItem('visits_count', counter);
                        localStorage.setItem('last_visit', new Date());
                    }
                }
            }
            ...
            e.length && e.each(function () {
                !function (e) {
                    ...
                    var a = {
                        trigger: "focus", template: '<div class="popover' + t + '" role="tooltip"><div class="arrow"></div><h3 class="popover-header"></h3><div class="popover-body"></div></div>'
                    };
                    e.popover(a)
                }($(this))
            })
            ...
            return {
                colors: {
                    gray: {
                        ...
                        primary: e.getPropertyValue("--primary") ? e.getPropertyValue("--primary").replace(" ", "") : "#6e00ff", info: e.getPropertyValue("--info") ? e.getPropertyValue("--info").replace(" ", "") : "#00B8D9", success: e.getPropertyValue("--success") ? e.getPropertyValue("--success").replace(" ", "") : "#36B37E", danger: e.getPropertyValue("--danger") ? e.getPropertyValue("--danger").replace(" ", "") : "#FF5630", warning: e.getPropertyValue("--warning") ? e.getPropertyValue("--warning").replace(" ", "") : "#FFAB00", dark: e.getPropertyValue("--dark") ? e.getPropertyValue("--dark").replace(" ", "") : "#212529"
            ...
            function a(e) {
                var t = e.attr("href"), a = e.data("scroll-to-offset") ? e.data("scroll-to-offset") : 0, n = {
            ...
            e.length && e.on("submit", function (e) {
                return function (e, a) {
                    ...
                    if (a.isDefaultPrevented())
                        ...
                        console.log(o);
                        var i = $.ajax({
                            type: "POST", url: e.data("process"), data: o, dataType: "json"
                        });
            ...
            void 0 !== n && null != n && google.maps.event.addDomListener(window, "load", function (n) {
                ...
                var o = new google.maps.LatLng(e, t), i = {
                    zoom: 12, scrollwheel: !1, center: o, mapTypeId: google.maps.MapTypeId.ROADMAP, styles: [{
                ...
                var s = new google.maps.Marker({
                    position: o, map: n, animation: google.maps.Animation.DROP, title: "Hello World!"
            ...
            void 0 !== a && null != a && google.maps.event.addDomListener(window, "load", function (a) {
                ...
                var n = new google.maps.LatLng(e, t), o = {
                    zoom: 12, scrollwheel: !1, center: n, mapTypeId: google.maps.MapTypeId.ROADMAP
                };
                a = new google.maps.Map(a, o);
                var i = new google.maps.Marker({
                    position: n, map: a, animation: google.maps.Animation.DROP, title: "Hello World!"
        ...
        if ($('[data-toggle="widget-calendar"]')[0]) {
            ...
            var calendar = new FullCalendar.Calendar($('[data-toggle ="widget-calendar"]')[0], {
                contentHeight: "auto",
                headerToolbar: false,
                ...
                events: [
                    {
                        title: "Call with Dave", start: "2021-12-18", end: "2021-12-18", className: "bg-danger"
                    },
                    {
                        title: "Lunch meeting", start: "2021-12-21", end: "2021-12-22", className: "bg-warning"
                    },
                    {
                        title: "All day conference", start: "2021-12-29", end: "2021-12-29", className: "bg-success"
                    },
                    {
                        title: "Meeting with Mary", start: "2022-01-01", end: "2022-01-01", className: "bg-info"
                    },
                    {
                        title: "Winter Hackaton", start: "2022-01-03", end: "2022-01-03", className: "bg-danger"
                    },
                    {
                        title: "Digital event", start: "2022-01-07", end: "2022-01-09", className: "bg-warning"
                    },
                    {
                        title: "Marketing event", start: "2022-01-10", end: "2022-01-10", className: "bg-primary"
                    },
                    {
                        title: "Dinner with Family", start: "2022-01-19", end: "2022-01-19", className: "bg-danger"
                    },
                    {
                        title: "Black Friday", start: "2022-01-23", end: "2022-01-23", className: "bg-info"
                    },
                    {
                        title: "Cyber Week", start: "2022-01-02", end: "2022-01-02", className: "bg-warning"
                    }
                ]
            });
            ...
            if (calendar.isRendered) {
                ...
                var calendar_events = $(calendar.currentData.options.events);

                var calendar_events_holder = $('.fc-daygrid-event-harness');

                calendar_events_holder.each(function () {

                    var dropdown_holder = $(this);
                    dropdown_holder.addClass('dropdown');
                    dropdown_holder.find('a').attr('role', 'button');
                    dropdown_holder.find('a').attr('data-bs-toggle', 'dropdown');
                    dropdown_holder.find('a').attr('data-bs-auto-close', 'outside');
                    dropdown_holder.find('a').attr('aria-expanded', 'false');
                    dropdown_holder.append('<div class="dropdown-menu border"></div>');


                    var link = $(this).find('a');

                    calendar_events.each(function () {
                        if (($(this)[0]).title === (link[0]).fcSeg.eventRange.def.title) {
                            var id = (link[0]).fcSeg.eventRange.def.title
                                    .replace(/\s/ig, '_').toLowerCase();
                            link.attr('id', id);
                        }
                    });

                    dropdown_holder.find('.dropdown-menu')
                            .append('<h4 class="dropdown-header event__title"></h4>');

                    dropdown_holder.find('.dropdown-menu')
                            .append('<p class="dropdown-item event__start"></p>');

                    dropdown_holder.find('.dropdown-menu')
                            .append('<p class="dropdown-item event__end"></p>');

                    dropdown_holder.find('.dropdown-menu')
                            .append('<div class="btn-group dropdown-item event__operations" role="group" aria-label="Operations"></div>');
                    dropdown_holder.find('.dropdown-menu').find('.btn-group')
                            .append('<button class="btn btn-secondary" type="button"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button>');
                    dropdown_holder.find('.dropdown-menu').find('.btn-group')
                            .append('<button class="btn btn-outline-danger" type="button"><i class="fa fa-trash" aria-hidden="true"></i></button>');

                    dropdown_holder.find('.dropdown-menu')
                            .attr('aria-labelledby', link.attr('id'));

                    dropdown_holder.find('.dropdown-menu')
                            .find('.event__title')
                            .text((link[0]).fcSeg.eventRange.def.title);

                    var ev_start_date = (link[0]).fcSeg.eventRange.range.start;
                    var startdateString =
                            ev_start_date.getUTCFullYear() + "-" +
                            ("0" + (ev_start_date.getUTCMonth() + 1)).slice(-2) + "-" +
                            ("0" + ev_start_date.getUTCDate()).slice(-2) + " " +
                            ("0" + ev_start_date.getUTCHours()).slice(-2) + ":" +
                            ("0" + ev_start_date.getUTCMinutes()).slice(-2);

                    dropdown_holder.find('.dropdown-menu')
                            .children('.event__start')
                            .html('<span class="event__start--title font-weight-bold">Start Date: ' +
                                    '</span><span class="event__start--description">'
                                    + startdateString + '</span>');

                    var ev_end_date = (link[0]).fcSeg.eventRange.range.end;
                    var enddateString =
                            ev_end_date.getUTCFullYear() + "-" +
                            ("0" + (ev_end_date.getUTCMonth() + 1)).slice(-2) + "-" +
                            ("0" + ev_end_date.getUTCDate()).slice(-2) + " " +
                            ("0" + ev_end_date.getUTCHours()).slice(-2) + ":" +
                            ("0" + ev_end_date.getUTCMinutes()).slice(-2);

                    dropdown_holder.find('.dropdown-menu')
                            .children('.event__end')
                            .html('<span class="event__end--title font-weight-bold">End Date: ' +
                                    '</span><span class="event__end--description">'
                                    + enddateString + '</span>');
            ...
            e.fn.countTo = function (t) {
                return t = t || {
                    ...
                    var a = e.extend({
                        ...
                        from: e(this).data("from"), to: e(this).data("to"), speed: e(this).data("speed"), refreshInterval: e(this).data("refresh-interval"), decimals: e(this).data("decimals")
                    }, t), n = Math.ceil(a.speed / a.refreshInterval), o = (a.to - a.from) / n, i = this, s = e(this), r = 0, l = a.from, d = s.data("countTo") || {
                    };
                    function c(e) {
        ...
        var Counter = function () {
            ...
            e.length && e.each(function () {
                $(this).flatpickr({
                    enableTime: !1, allowInput: !0
                })
            }), t.length && t.each(function () {
                $(this).flatpickr({
                    enableTime: !0, allowInput: !0
                })
            }), a.length && a.each(function () {
                $(this).flatpickr({
                    noCalendar: !0, enableTime: !0, allowInput: !0
                })
            })
        }();
        !function (e) {
        ...
        var Dropzones = function () {
         ...
         id: 1, title: "Call with Dave", start: "2019-04-18", allDay: !0, className: "bg-danger", description: "Nullam id dolor id nibh ultricies vehicula ut id elit. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus."
         }, {
         id: 2, title: "Lunch meeting", start: "2019-04-21", allDay: !0, className: "bg-warning", description: "Nullam id dolor id nibh ultricies vehicula ut id elit. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus."
         }, {
         ...
         id: 4, title: "Meeting with Mary", start: "2019-05-01", allDay: !0, className: "bg-info", description: "Nullam id dolor id nibh ultricies vehicula ut id elit. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus."
         }, {
         ...
         id: 6, title: "Digital event", start: "2019-05-07", allDay: !0, className: "bg-warning", description: "Nullam id dolor id nibh ultricies vehicula ut id elit. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus."
         }, {
         ...
         id: 8, title: "Dinner with Family", start: "2019-05-19", allDay: !0, className: "bg-danger", description: "Nullam id dolor id nibh ultricies vehicula ut id elit. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus."
         }, {
         id: 9, title: "Black Friday", start: "2019-05-23", allDay: !0, className: "bg-info", description: "Nullam id dolor id nibh ultricies vehicula ut id elit. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus."
         }, {
         id: 10, title: "Cyber Week", start: "2019-05-02", allDay: !0, className: "bg-yellow", description: "Nullam id dolor id nibh ultricies vehicula ut id elit. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus."
         }], dayClick: function (e) {
         ...
         id: a.Job(), title: t, start: $(".new-event--start").val(), end: $(".new-event--end").val(), allDay: !0, className: $(".event-tag input:checked").val()
         ...
         t.preventDefault(), e.fullCalendar("prev")
            ...
            e.length && e.each(function () {
                ...
                e = $(this), t = e.find(".masonry"), a = e.find(".masonry-filter-menu"), n = a.find(".active"), o = n.data("filter"), i = t.imagesLoaded(function () {
                    ...
                    var e = {
                        itemSelector: ".masonry-item", filter: o
                    };
                    i.isotope(e)
            ...
            e.length && e.each(function () {
                ...
                e = $(this), t = e.find(".input-slider"), a = t.attr("id"), n = t.data("range-value-min"), o = t.data("range-value-max"), i = e.find(".range-slider-value"), s = i.attr("id"), r = i.data("range-value-low"), l = document.getElementById(a), d = document.getElementById(s), c = {
                    start: [parseInt(r)], connect: [!0, !1], range: {
                        min: [parseInt(n)], max: [parseInt(o)]
                    }
            ...
            e.length && e.each(function () {
                ...
                $(this), e = document.getElementById("input-slider-range"), t = document.getElementById("input-slider-range-value-low"), a = document.getElementById("input-slider-range-value-high"), n = [t, a], noUiSlider.create(e, {
                    start: [parseInt(t.getAttribute("data-range-value-low")), parseInt(a.getAttribute("data-range-value-high"))], connect: !0, range: {
            ...
            e.length && e.each(function () {
                ...
                e = $(this), t = e.data().progress, a = e.data().text ? e.data().text : "", n = e.data().textclass ? e.data().textclass : "progressbar-text", o = e.data().color ? e.data().color : "primary", i = {
                    color: PurposeStyle.colors.theme[o], strokeWidth: 7, trailWidth: 2, text: {
                        value: a, className: n
                    }, svgStyle: {
                        display: "block"
            ...
            $(document).ready(function () {
                e.length && e.each(function (e, t) {
                    ...
                    a = $(t), n = a.find(".swiper-container"), o = a.find(".swiper-pagination"), i = a.find(".swiper-button-next"), s = a.find(".swiper-button-prev"), r = n.data("swiper-effect") ? n.data("swiper-effect") : "slide", l = n.data("swiper-direction") ? n.data("swiper-direction") : "horizontal", d = n.data("swiper-initial-slide") ? n.data("swiper-initial-slide") : 0, c = !!n.data("swiper-autoheight") && n.data("swiper-autoheight"), u = !!n.data("swiper-autoplay") && n.data("swiper-autoplay"), p = !!n.data("swiper-centered-slides") && n.data("swiper-centered-slides"), g = n.data("swiper-pagination-type") ? n.data("swiper-pagination-type") : "bullets", f = n.data("swiper-items"), h = n.data("swiper-sm-items"), m = n.data("swiper-md-items"), v = n.data("swiper-lg-items"), y = n.data("swiper-xl-items"), b = n.data("swiper-space-between"), w = n.data("swiper-sm-space-between"), C = n.data("swiper-md-space-between"), k = n.data("swiper-lg-space-between"), x = n.data("swiper-xl-space-between"), f = f || 1, h = h || f, m = m || h, v = v || m, y = y || v, b = b || 0, w = w || b, C = C || w, k = k || C, x = x || k, new Swiper(n, {
                        pagination: {
                            el: o, clickable: !0, type: g
                        }, navigation: {
                            nextEl: i, prevEl: s
                        }, slidesPerView: f, spaceBetween: b, initialSlide: d, autoHeight: c, centeredSlides: p, mousewheel: !1, keyboard: {
                            enabled: !0, onlyInViewport: !1
                        }, grabCursor: !0, autoplay: u, effect: r, coverflowEffect: {
                            rotate: 10, stretch: 0, depth: 50, modifier: 3, slideShadows: !1
                        }, speed: 800, direction: l, preventClicks: !0, preventClicksPropagation: !0, observer: !0, observeParents: !0, breakpointsInverse: !0, breakpoints: {
                            575: {
                                slidesPerView: h, spaceBetweenSlides: w
                            }, 767: {
                                slidesPerView: m, spaceBetweenSlides: C
                            }, 991: {
                                slidesPerView: v, spaceBetweenSlides: k
                            }, 1199: {
                                slidesPerView: y, spaceBetweenSlides: x
                            }
                        }
                    })
                })
            ...
            e.length && e.each(function () {
                ...
                e = $(this), t = "#" + e.attr("id"), a = (a = e.data("type-this")).split(","), n = new Typed(t, {
                    strings: a, typeSpeed: 100, backSpeed: 70, loop: !0
                ...
                !function (e) {
                    var t = {
                        chart: {
                            ...
                            width: 7, curve: "smooth"
                        }, series: [{
                                name: "Likes", data: [4, 3, 10, 9, 29, 19, 22, 9]
                            }], xaxis: {
                            labels: {
                                format: "MMM", style: {
                            ...
                            }, type: "datetime", categories: ["1/11/2000", "2/11/2000", "3/11/2000", "4/11/2000", "5/11/2000", "6/11/2000", "7/11/2000", "8/11/2000"]
                        }, yaxis: {
                            labels: {
                                style: {
                            ...
                            size: 4, opacity: .7, strokeColor: "#fff", strokeWidth: 3, hover: {
                                size: 7
                            }
                        }, grid: {
                            borderColor: PurposeStyle.colors.gray[300], strokeDashArray: 5
                        }, dataLabels: {
                            enabled: !1
                        }
                    ...
                    var t = {
                        chart: {
                            ...
                            width: 7, curve: "smooth"
                                ...
                                name: "Likes", data: [4, 3, 10, 9, 29, 19, 22, 9, 12, 7, 19, 5, 13, 9]
                            }], xaxis: {
                            labels: {
                                format: "MMM", style: {
                                    colors: PurposeStyle.colors.gray[600], fontSize: "14px", fontFamily: PurposeStyle.fonts.base, cssClass: "apexcharts-xaxis-label"
                                ...
                                show: !0, borderType: "solid", color: PurposeStyle.colors.gray[300], height: 6, offsetX: 0, offsetY: 0
                            }, type: "datetime", categories: ["1/11/2000", "2/11/2000", "3/11/2000", "4/11/2000", "5/11/2000", "6/11/2000", "7/11/2000", "8/11/2000", "9/11/2000", "10/11/2000", "11/11/2000", "12/11/2000", "1/11/2001", "2/11/2001"]
                        }, yaxis: {
                            labels: {
                                style: {
                                    color: PurposeStyle.colors.gray[600], fontSize: "12px", fontFamily: PurposeStyle.fonts.base
                ...
                !function (e) {
                    var t = {
                        chart: {
                            ...
                            bar: {
                                horizontal: !1, columnWidth: "30%", endingShape: "rounded"
                            }
                        }, stroke: {
                            show: !0, width: 2, colors: ["transparent"]
                        }, series: [{
                                name: "Worked hours", data: [40, 30, 100, 90, 20]
                            }], xaxis: {
                            labels: {
                                format: "MMM", style: {
                                    colors: PurposeStyle.colors.gray[600], fontSize: "14px", fontFamily: PurposeStyle.fonts.base, cssClass: "apexcharts-xaxis-label"
                                ...
                                show: !0, borderType: "solid", color: PurposeStyle.colors.gray[300], height: 6, offsetX: 0, offsetY: 0
                            }, type: "datetime", categories: ["1/11/2000", "2/11/2000", "3/11/2000", "4/11/2000", "5/11/2000"]
                        }, yaxis: {
                            labels: {
                                style: {
                                    color: PurposeStyle.colors.gray[600], fontSize: "12px", fontFamily: PurposeStyle.fonts.base
